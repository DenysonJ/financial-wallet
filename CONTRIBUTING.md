...
Obrigado pelo interesse em contribuir com o **Financial Wallet**!

## Como comecar

1. Clone o projeto: `git clone https://github.com/DenysonJ/financial-wallet`
2. Crie uma branch: `git checkout -b feat/minha-feature`
3. Setup: `make setup` (instala tools, sobe Docker, roda migrations)

## Propor features e reportar bugs

Use o **Issue Tracker** do GitHub para sugerir melhorias ou reportar problemas:

1. Acesse [Issues](https://github.com/DenysonJ/financial-wallet/issues)
