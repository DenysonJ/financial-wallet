...
func TestListFilter_Normalize(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: ListFilter{Page: 1, Limit: 10},
		},
		{
		...
		},
		{
			...
			expected: ListFilter{Page: 1, Limit: 100},
		},
		{
			name:     "page negativo é normalizado",
			input:    ListFilter{Page: -1, Limit: 20},
			expected: ListFilter{Page: 1, Limit: 20},
		},
		{
			name:     "limit negativo é normalizado",
			input:    ListFilter{Page: 1, Limit: -5},
			expected: ListFilter{Page: 1, Limit: 10},
		},
	}
