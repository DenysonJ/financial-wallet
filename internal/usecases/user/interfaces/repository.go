...
type Repository interface {
	...
	// UpdatePassword atualiza o hash da senha de um User ativo.
	// Retorna ErrUserNotFound se o ID não existir ou o user estiver inativo.
	UpdatePassword(ctx context.Context, id vo.ID, passwordHash string) error
}
