...
-- Role-Permission junction. Composite PK (role_id, permission_id) covers
-- `WHERE role_id = $1` lookups; no single-column index needed.
...
-- User-Role junction. Composite PK (user_id, role_id) covers user-id lookups.
