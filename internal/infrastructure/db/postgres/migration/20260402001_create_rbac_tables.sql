...
-- Role-Permission junction (which permissions each role has)
...
INSERT INTO permissions (id, name, description) VALUES
    ('00000000-0000-0000-0000-000000000001', 'user:read', 'Read user data'),
    ('00000000-0000-0000-0000-000000000002', 'user:write', 'Create and update users'),
    ('00000000-0000-0000-0000-000000000003', 'user:delete', 'Delete users'),
    ('00000000-0000-0000-0000-000000000004', 'role:read', 'Read roles'),
    ('00000000-0000-0000-0000-000000000005', 'role:write', 'Create, update, assign and revoke roles'),
    ('00000000-0000-0000-0000-000000000006', 'role:delete', 'Delete roles');
